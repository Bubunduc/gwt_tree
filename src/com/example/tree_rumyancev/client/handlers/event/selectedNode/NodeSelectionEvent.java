...
public class NodeSelectionEvent extends GwtEvent<NodeSelectionEventHandler> {
	public static final Type<NodeSelectionEventHandler> TYPE = new Type<NodeSelectionEventHandler>();
